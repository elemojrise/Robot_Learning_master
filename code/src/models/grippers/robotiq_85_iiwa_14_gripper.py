...
class Robotiq85GripperBaseOriginal(GripperModel):
    """
...
class Robotiq85Gripper_iiwa_14(Robotiq85GripperBaseOriginal):
    """
...
class Robotiq85GripperBaseLongerFinger(GripperModel):
    """
    6-DoF Robotiq gripper.
    ...
    def __init__(self, idn=0):
        ...
        if loc == '/home/kukauser/dev_ws': #if we are using the MANULAB computer and running policy node from dev_ws
            loc = '/home/kukauser/Robot_Learning_master/code'
        loc = loc + "/src/models/assets/"
        super().__init__(xml_path_completion(loc + "grippers/robotiq_gripper_85_longer_finger.xml"), idn=idn)
...
class Robotiq85Gripper_iiwa_14_longer_finger(Robotiq85GripperBaseLongerFinger):
    """
    1-DoF variant of RobotiqGripperBase.
    """
