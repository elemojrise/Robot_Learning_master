...
from robosuite.models.objects import BottleObject, CanObject, LemonObject, BreadObject, MilkObject, CerealObject, SquareNutObject, RoundNutObject, MilkVisualObject, BreadVisualObject, CerealVisualObject, CanVisualObject, PlateWithHoleObject
import random
...
class Lift_edit_multiple_objects(SingleArmEnv):
    """
    ...
    def __init__(
        ...
        table_full_size=(2, 1, 0.05), #Hallaballa
        ...
        objects = [BottleObject(name = "Bottle"),
                    ...
                    MilkObject(name = "Milk"),
                    BreadObject(name = "Bread"),
                    CerealObject(name = "Cereal"),
                    SquareNutObject(name = "SquareNut"),
                    RoundNutObject(name = "RoundNut"),
                    ],
        ):
    ...
    def _setup_references(self):
        ...
        self.cube_body_id = self.sim.model.body_name2id(self.target.root_body)
    ...
    def _check_success(self):
        ...
        return cube_height > table_height + 0.04 and self._check_grasp(gripper=self.robots[0].gripper, object_geoms=self.target)