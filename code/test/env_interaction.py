...
if __name__ == "__main__":
    ...
    parser.add_argument("--robots", nargs="+", type=str, default="IIWA_14_modified", help="Which robot(s) to use in the env")
    parser.add_argument(
    ...
    controller_config["position_limits"] = [[-np.inf,-np.inf, 0.839],[np.inf, np.inf, np.inf]]
    ...
    while True:
        ...
        while True:
            ...
            #print(obs)
            #print(obs["gripper_status"], reward)
            print(obs["robot0_eef_pos"], obs["robot0_joint_pos"])
            env.render()
